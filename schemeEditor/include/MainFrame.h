...
protected:
    ...
    void getBlockData(vecString &BlockType,vecString &BlockName, vecString &Gain,
                        vecString &NF, vecString &InputName, vecString &OutputName,
                        vecString &NumberOfInPorts, vecString &NumberOfOutPorts);
    void getNetData(std::vector<wxSFShapeBase*> &shapeArray, vecString &InputName, vecString &OutputName);
